...
2) ZERO_DIAGNOSIS.py
3) CONSISTENCY_TEST_CONFIGURATIONS.py
4) NUMERICAL_STABILITY_TEST.py

Run...

1) HIGH_MASS_MAPS_CREATION_DESI.py
2) DESI_DATA_QUALITY_ANALYSIS.py
3) ROBUSTNESS_DESI_VALIDATION.py
4) SDSS_VS_DESI_QUALITY_ANALYSIS.py
5) REGENERATE_REAL_ROBUSTNESS_DATA.py
6) COMPLETE_BIAS_QUANTIFICATION.py
7) FABER_JACKSON_DESI_ANALYSIS.py
8) EXTREME_SDSS_VDISP_ANALYSIS.py
9) DESI_VORTICITY_SPECTRAL_ANALYSIS.py
10) ANGULAR_BISPECTOR_VORTICITY_DESI.py
11) DESI_MASS_THRESHOLD_TUNING.py
12) ESTIMATE_N_OMEGA_VDISP.py
