#!/usr/bin/env python3
"""
VALIDACIÓN OPTIMIZADA PARA 5σ - 40 MUESTRAS
"""

import numpy as np
import json
from scipy import stats # Importado para la sección final
...
print(f"   • Muestras: 40 (vs 5 original)") # MODIFICACIÓN 1: 25 -> 40
...
for z_min, z_max, label in bins_paper:
    ...
    # 🚀 40 MUESTRAS
    for semilla in range(40): # MODIFICACIÓN 2: 25 -> 40
...
# 🎯 CÁLCULO DE EVOLUCIONES (40 MUESTRAS)
...
if 'z01_02' in resultados_comparativos and 'z07_08' in resultados_comparativos:
    ...
    # Para cada una de las 40 muestras, calcular evolución individual
    for semilla in range(40): # MODIFICACIÓN 3: 25 -> 40
        np.random.seed(semilla)
...
if evoluciones_esc:
    ...
    # Se utiliza H0 = 1.1x para la significancia más rigurosa (como en el análisis DESI)
